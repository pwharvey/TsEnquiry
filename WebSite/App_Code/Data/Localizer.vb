...
Namespace RedStag.Data
    ...
    Public Class Localizer
        ...
        Public Shared Function CreateDictionaryStream(ByVal culture As String, ByVal baseName As String, ByVal objectName As String, ByRef files() As String) As Stream
            ...
            Dim result As Stream = t.Assembly.GetManifestResourceStream(CultureManager.ResolveEmbeddedResourceName(String.Format("RedStag.{0}{1}", baseName, fileName), culture))
            If (result Is Nothing) Then
                result = t.Assembly.GetManifestResourceStream(CultureManager.ResolveEmbeddedResourceName(String.Format("RedStag.{0}", fileName), culture))
            End If
            If (result Is Nothing) Then
        ...
        Public Shared Function CreateDictionary(ByVal baseName As String, ByVal objectName As String) As LocalizationDictionary
            ...
            Dim fileName As String = String.Format("RedStag.{0}.{1}.txt", objectName, culture)
