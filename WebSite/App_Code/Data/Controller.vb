    ...
    Partial Public Class DataControllerBase
        ...
        Public Shared Function CreateConfigurationInstance(ByVal t As Type, ByVal controller As String) As ControllerConfiguration
            ...
            If (config Is Nothing) Then
                ...
                If (res Is Nothing) Then
                    res = t.Assembly.GetManifestResourceStream(String.Format("RedStag.Controllers.{0}.xml", controller))
                End If
                If (res Is Nothing) Then
                    res = t.Assembly.GetManifestResourceStream(String.Format("RedStag.{0}.xml", controller))
                End If
                If (res Is Nothing) Then
        ...
        Public Overloads Shared Function CreateReportInstance(ByVal t As Type, ByVal name As String, ByVal controller As String, ByVal view As String, ByVal validate As Boolean) As String
            ...
            If (t Is Nothing) Then
                t = GetType(RedStag.Data.Controller)
            End If
            Dim res As Stream = t.Assembly.GetManifestResourceStream(String.Format("RedStag.Reports.{0}", name))
            If (res Is Nothing) Then
                res = t.Assembly.GetManifestResourceStream(String.Format("RedStag.{0}", name))
            End If
            If (res Is Nothing) Then
            ...
            If isGeneric Then
                ...
                Dim config As ControllerConfiguration = RedStag.Data.Controller.CreateConfigurationInstance(t, controller)
