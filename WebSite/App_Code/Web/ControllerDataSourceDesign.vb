    ...
    Public Class ControllerDataSourceDesignView
        ...
        Public Overrides ReadOnly Property Schema() As IDataSourceViewSchema
            Get
                ...
                Dim res As Stream = [GetType]().Assembly.GetManifestResourceStream(String.Format("RedStag.Controllers.{0}.xml", DataController))
                If (res Is Nothing) Then
                    res = [GetType]().Assembly.GetManifestResourceStream(String.Format("RedStag.{0}.xml", DataController))
                End If
